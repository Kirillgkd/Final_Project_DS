...
''')
st.markdown("P.S. Ячейки кода предоставлены для отражения логики. Для полноценного запуска и дополнительных деталей обратитесь к Final.ipynb из репозитория")
...
st.markdown("На этом все! Спасибо за внимание!")
st.markdown("**Исходный код см. в Final.ipynb**")
